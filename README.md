...
[![Version](https://img.shields.io/badge/version-2.9.4-orange)](https://github.com/pedroespinal/STWHub/releases/latest)
...
> **[⬇ Descargar STWHub-2.9.4.apk](https://github.com/pedroespinal/STWHub/releases/latest)**
...
|---------|-------|------------|
| **2.9.4** | 49 | Fix URL Patch Notes → solo STW (fortnite.com/news/tag/save-the-world) |
