...
> **STW Hub v2.5.7** · Creado por: Pedro Espinal · Todos los derechos reservados © 2026
...
chcp 65001 | Out-Null
cd C:\STWHub
flet build apk --artifact "STWHub-2-5-7"
```
...
|---------|-------|---------------------|
| 2.5.7   | 28    | Fix FtS Cat 3/4 (parse_generator full-path lookup first), SC detection por tipo (reward label XpMultiplierCard), 6 community builds, admin removido completamente |
| 2.5.6   | 27    | Admin eliminado (app igual para todos), FtS compound keys, SC type badges |
